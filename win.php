...
return false;
  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 col-sm bg-white">
     ...
     <span id="bas" class=" col-10 col-sm-11 col-md-11 col-lg-12 col-xl-12 ml-3 mt-4 text-secondary">WinRAR </span>
          ...
          <div id="mt2image" class="carousel-inner mx-auto">
            <div class="carousel-item active">
              <img src="Winrar images/images.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="Winrar images/images (1).jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="Winrar images/0.png" class="d-block w-100" alt="...">
            </div>            
          </div>
    ...
    <div class="col-8 col-sm-5 col-md-5 col-lg-5 col-xl-5 bg-info" style="margin-top:0px; border-radius:5px; height:50px; line-height:50px; text-align:center; width:500px;"><span style="font-weight:bold; color:#FFF;">Program Hakkında</span></div>
     ...
     <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 bg-white" style="margin-top:20px; border-radius:5px; height:auto;  text-align:left; width:auto;">
            ...
            <span style="font-weight:300; color:#000; "> Winrar</span><br/>		
            ...
            <span style="font-weight:300; color:#000;">Full Sürüm</span><br/>

			<span style="font-weight:bold; color:#333; margin-right:4px;  text-shadow:0 0 5px #00FFFF;">Tür:</span> 
            <span style="font-weight:300; color:#000; margin-right:4px;">Dosya Sıkıştırma</span><br/>
           ...
           <span style="font-weight:300; color:#000; margin-right:4px;">v5.80 Beta 3</span><br/>
            
                       
          <span style="font-weight:bold; color:#333; margin-right:4px; text-shadow:0 0 5px #00FFFF;">  Geliştiricisi:</span> 
          <span style="font-weight:300; color:#000;">RarSoft</span><br/>
           ...
           <span style="font-weight:300; color:#000;">Setup</span><br/>
           ...
           <span style="font-weight:300; color:#000;">5.8 MB</span><br/>
     ...
     <div class="col-5 col-sm-5 col-md-5 col-lg-5 col-xl-5 bg-info" style="margin-top:50px; border-radius:5px; height:50px; line-height:50px; text-align:center; width:500px;"><span style="font-weight:bold; color:#FFF;">Genel Bakış </span></div>
      ...
      <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 bg-white" style="margin-top:10px; margin-bottom:10px; border-radius:5px; height:auto; text-align:left; width:auto;">
     	<span style="margin-bottom:100px;">	<span style="font-weight:bold; color:#333; margin-right:4px; text-shadow:0 0 5px #00FFFF;">WinRAR</span><br/>
            <span  style="font-weight:300; color:#000;"> Sıkıştırılmış dosyaları açabileceğiniz ve dosyalarınızı sıkıştırabileceğiniz güçlü bir arşiv programıdır. Gelişmiş özellikleri ile winrar, bilinmekte olan tüm dosya sıkıştırma formatlarını desteklemektedir. Winrar kullanarak saklamak istediğiniz dosyalarınızın kalitesinden ödün vermeden en iyi şekilde sıkıştırıp diskten yer kazanabilir, şifreleme yöntemi ile koruma altına alabilirsiniz.</span><br/> 
            
  Dosyaları ciltlere bölme özelliği sayesinde büyük boyutlu dosyaları sıkıştırıp bölerek çok daha rahat bir şekilde saklayabilir veya paylaşabilirsiniz. Kurtarma kaydı oluşturma, dosya isimlerini şifreleme ve arşivi kilitleme gibi özellikleri sayesinde güvenli arşivler oluşturabilirsiniz. Sağ tık menüsüne entegre oluyor olması ve çoklu dil desteği avantajı oldukça rahat bir kullanım sağlıyor.   <br/>
            
<b>Popüler sıkıştırılmış dosya formatları;</b><br>
rar, zip, iso, 7z, cab, arj, lzh, tar, gz, ace, uue, bz2, jar            
  ...
  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/z4_fKf_m6HI" allowfullscreen></iframe>
</div>
   ...
   <b>Winrar Full Sürüm 32 Bit veya 64 Bit indir</b><br>


   	<div style="margin-bottom:20px;">	<span style="font-weight:bold; color:#333; margin-right:4px; text-shadow:0 0 5px #00FFFF;"> İndirme Linki 1:</span> 
           <span style="font-weight:500; color:#000; margin-right:4px; ">
           
           <a href="https://bit.ly/3679OiU" target="_blank"> Direkt İndir</a></span>
           
           </div>
           
           
           <div style="margin-bottom:20px;">	<span style="font-weight:bold; color:#333; margin-right:4px; text-shadow:0 0 5px #00FFFF;"> İndirme Linki 2:</span> 
           <span style="font-weight:500; color:#000; margin-right:4px; ">
           
           <a href="https://drive.google.com/file/d/1DgDziI83RzK4e2HraJQq90eSpjo8dBhd/view" target="_blank"> Google Drive</a></span>
           
           </div>
           
           
           <div style="margin-bottom:20px;">	<span style="font-weight:bold; color:#333; margin-right:4px; text-shadow:0 0 5px #00FFFF;"> İndirme Linki 3:</span> 
           <span style="font-weight:500; color:#000; margin-right:4px; ">
           
           <a href="https://www.rarlab.com/rar/wrar571tr.exe" target="_blank"> Winrar 32 Bit indir</a></span>
           
           </div>
           
           
           <div style="margin-bottom:20px;">	<span style="font-weight:bold; color:#333; margin-right:4px; text-shadow:0 0 5px #00FFFF;"> İndirme Linki 4:</span> 
           <span style="font-weight:500; color:#000; margin-right:4px; ">
           
           <a href="https://www.rarlab.com/rar/winrar-x64-571tr.exe" target="_blank"> Winrar 64 Bit indir</a></span>
  ...
  <span class="a">E</span>
   ...
   <div class="col-11 col-sm-12 col-md-12 col-lg-12 col-xl-12 clearfix bg-white  mx-auto  mb-4 mt-3 " style=" width:auto; height:auto;"> 
      ...
      <a href="#"> <div class="card col-10 col-md-4 col-lg-5 col-xl-8 mt-2  ml-5" style="width:18rem; border:2px solid #999; float:left;">
          <img src="Winrar images/GOM-Player-İcon.png" class="card-img-top mt-1" style="border-bottom:2px solid #999;" alt="...">
          <div class="card-body">
            <p class="card-text text-secondary">
            <span style="font-weight:bold; color:#0CC; margin-right:4px;">GOM Player İndir </span><br/>
<span class="" style="font-size:14px; color:#8C8C8C; font-weight:500;">GOM Player İndir Bilgiler Program Adı: GOM Player Dili: Türkçe & İngilizce Türü: Medya Oynatıcı Sürümü: v2.3.19.5276 Lisansı: Ücretsiz Geliştiricisi: Gretech İşletim Sistemi: Windows...</span></p>
          </div>
        </div></a>
    
     <a href="#"> <div class="card col-10 col-md-4 col-lg-5 col-xl-8 mt-2 ml-5" style="width:18rem; border:2px solid #999; float:left;">
          <img src="Winrar images/eset-nod32-antivirus-programi.png" class="card-img-top mt-1" style="border-bottom:2px solid #999;" alt="...">
          <div class="card-body">
            <p class="card-text text-secondary">
           
          <span style="font-weight:bold; color:#0CC; margin-right:4px;">ESET NOD32 Antivirus İndir </span><br/>
                       
            <span class="" style="font-size:14px; color:#8C8C8C; font-weight:500;">ESET NOD32 Antivirus Full İndir Program’a Hızlı Bakış Program: ESET NOD32 Antivirus 2019 Platform: Bilgisayar İşletim Sistemi: Windows Vista / 7 / 8 / 10 Lisans: Ücretsiz Tür: Antivirüs Programı...</span></p>
          </div>
        </div></a>
      ...
      <a href="#"> <div class="card col-10 col-md-4 col-lg-5 col-xl-8 mt-2  ml-5" style="width:18rem; border:2px solid #999; float:left;">
          <img src="Winrar images/Internet-Download-Manager-İcon.png" class="card-img-top mt-1" style="border-bottom:2px solid #999;" alt="...">
          <div class="card-body">
            <p class="card-text text-secondary">
            <span style="font-weight:bold; color:#0CC; margin-right:4px;">Internet Download Manager Full İndir</span><br/>
            
 <span class="" style="font-size:14px; color:#8C8C8C; font-weight:500;">Internet Download Manager Full İndir Program’a Hızlı Bakış Program: Internet Download Manager (IDM) Platform: Bilgisayar İşletim Sistemi: Windows XP / 7 / 8 / 10 Lisans: Ücretsiz Tür: Full...</span> </p>
          </div>
        </div></a>
        
        
          <a href="#"> <div class="card col-10 col-md-4 col-lg-5 col-xl-8 ml-5 mt-2" style="width:18rem; border:2px solid #999; float:left;">
          <img src="Winrar images/Recover-My-Files-İcon.png" class="card-img-top mt-1" style="border-bottom:2px solid #999;" alt="...">
          <div class="card-body">
            <p class="card-text text-secondary">
         <span style="font-weight:bold; color:#0CC; margin-right:4px;">Veri Kurtarma Programı İndir</span><br/>
  <span class="" style="font-size:14px; color:#8C8C8C; font-weight:500;"> Veri Kurtarma Programı İndir Bilgiler Program Adı : Recover My Files Program Dili : İngilizce Program Türü : Veri Kurtarma Program Sürümü : v5.2.1 İşletim Sistemi : Windows XP+...</span></p>
          </div>
        </div></a>
