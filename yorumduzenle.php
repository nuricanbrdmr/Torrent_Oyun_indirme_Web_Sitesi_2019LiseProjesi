...
<?php 
    ...
    $id=$_GET["id"];
    $sorgu= $conn->prepare("SELECT * FROM yorumlar Where yorum_id=:id");
...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <div class="form-group input-group">
        ...
        <input name="mesaj" class="form-control" value="<?php echo $row["yorum_mesaj"] ?>" type="text">
    </div> <!-- form-group// -->
...
$guncelle = $conn -> prepare("UPDATE yorumlar SET yorum_mesaj=:mesaj Where yorum_id=:id");
$guncelle -> execute(array(":mesaj"=>$mesaj,":id"=>$id));
echo "İşlem Başarılı!";
if($guncelle){

  echo '<div style="margin-top:20px; color:green;">Yorumunuz Düzenlendi Sayfaya Geri Yönlendiriliyorsunuz!</div>';
