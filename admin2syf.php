...
<link rel="stylesheet" type="text/css" href="style.css">
  ...
  <?php 
    ...
    <div id="ana" class="container bg-light">
        ...
        <div id="login" class="row float-right mr-3" style="margin-top:100px;">
         ...
         <img src="resimler/login-icon-png-10.png" style="width:30px; height:30px; padding:0; margin-right:3px;"><span style="color:#000; font-size:14px; font-weight:bold;"><?php echo  $_SESSION['user']['Kadi']; ?></span></a>
 ...
 <button class="btn"  type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">     
         ...
         <button class="dropdown-item" type="button"><a>Kullanıcı Adı Değiştir</a></button>
         <button class="dropdown-item" type="button">Şifre Değiştir</button>
         <button class="dropdown-item text-danger" type="button">Hesap Sil</button>
  </div>
        </div>
  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent" class="d-block">
        ...
        <ul class="navbar-nav mr-auto ml-3">
          <li class="nav-item px-3" style=" border-right:1px solid #A6A6A6;">
            <a class="nav-link active text-light" title="Ana Sayfa" href="index.html" style="font-weight:600; text-align:center;">Ana Sayfa <span class="sr-only">(current)</span></a>
          </li>
    ...
    <div class="col-12 col-sm-11 col-md-12 col-lg-8 col-xl-8 bg-white">
     <div class="row ">
        ...
        <div id="box1" class="col-11 col-sm-12 col-md-11 col-lg-11 col-xl-11 bg-light ml-3 mb-5 mt-4 mr-5">
      ...
      height:122.5px; border:2px solid #999;">
       <img   src="macera images/Assassins-Creed-Unity-İcon.png" class="img-fluid w-100 mt-3" style=" width:300px; height:90px;"></div></a>
      ...
      <a href="#" >  <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 clearfix bg-light float-left  mb-2 mt-3 " style=" width:auto; height:122.5px; border:2px     	solid #999; border-left:none; ">
        <h6 style="color:#09F; font-weight:bold;">Assassin’s Creed Unity Full İndir </h6>
        <span id="box6" style="font-size:14px; color:#8C8C8C; font-weight:500;">Oyun Dili : İngilizce Oyun Türü : Aksiyon & Macera Oyun Sürümü : v1.4.0 Oyun<b style=" font-size:14px; font-weight:500;"> Eki : Bulunmuyor Platform : PC Crack : Gömülü Dosya Türü : Rar Dosya Boyutu : 31.2 GB  İşletim Sistemi : Windows 7 SP1</b>...</span></span></div></a>
        </div>
                                     
        
        <div id="box1" class="col-11 col-sm-12 col-md-11 col-lg-11 col-xl-11 bg-light ml-3 mt-0 mb-5 mr-5">
        
         <a href="#"> <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 clearfix float-left bg-light   mt-3" style="width:auto;
      height:122.5px; border:2px solid #999;">
       <img   src="bakım images/CCleaner-İcon.png" class="img-fluid w-100 mt-3" style=" width:300px; height:90px;"></div></a>
        
      <a href="#" >  <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 clearfix bg-light float-left  mb-2 mt-3 " style=" width:auto; height:122.5px; border:2px     	solid #999; border-left:none; ">
        <h6 style="color:#09F; font-weight:bold;">CCleaner Business Edition 5.17 Full Türkçe İndir</h6>
        <span id="box2" style="font-size:14px; color:#8C8C8C; font-weight:500;">CCleaner, bilgisayarımızın gereksinim duyduğu bakım ve <b style=" font-size:14px; font-weight:500;">temizlik işlemlerini gerçekleştiren çok işlevli bir programdır. Bilgisayarımıza yükleyip <span>kaldırdığımız oyunlar, sürekli kullandığımız programlar ve sistemde otomatik olarak oluşan</span></b>...</span></span></span></div></a>
        ...
        <div id="box1" class="col-11 col-sm-12 col-md-11 col-lg-11 col-xl-11 bg-light ml-3 mb-5 mr-5">
           <a href="#"> <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 clearfix float-left bg-light   mt-3" style="width:auto;
      height:122.5px; border:2px solid #999;">
       <img   src="macera images/GTA-San-Andreas-İcon.png" class="img-fluid  mt-3" style=" width:300px; height:90px;"></div></a>
        
      <a href="#" >  <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 clearfix bg-light float-left  mb-2 mt-3 " style=" width:auto; height:122.5px; border:2px solid #999; border-left:none; ">
        <h6 style="color:#09F; font-weight:bold;">GTA San Andreas İndir</h6>
        <span id="box4"> Grand Theft Auto: San Andreas, Rockstar Games tarafından geliştirilen serinin en eski ve en çok oynanan<b style=" font-size:14px; font-weight:500;"> açık dünya oyunudur.  Gereksinim Seviyesi: Düşük İşletim Sistemi: Windows XP / Windows Vista / Windows 7 <span>Ekran Kartı: DirectX9 Destekli</span></b>...</span></span></div></a>
           ...
           <a href="#"> <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 clearfix float-left bg-light   mt-3" style="width:auto;
      height:122.5px; border:2px solid #999;">
       <img   src="bakım images/Advanced-System-Care-İcon.png" class="img-fluid  mt-3" style=" width:300px; height:90px;"></div></a>
        
      <a href="#" >  <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 clearfix bg-light float-left  mb-2 mt-3 " style=" width:auto; height:122.5px; border:2px solid #999; border-left:none; ">
        <h6 style="color:#09F; font-weight:bold;">Advanced System Care İndir</h6>
        <span id="box4"> Program Adı: Advanced System Care Dili: Türkçe & İngilizce Türü: Sistem <b style=" font-size:14px; font-weight:500;">Bakım Programı Sürümü: v10.5.0.870 Lisansı: Ücretsiz Geliştiricisi: IObitHakkında Advanced System Care, IObit firması <span>tarafından geliştirilen ve işletim sisteminizin</span></b>...</span></span></div></a>
        ...
        <div id="box1" class="col-11 col-sm-12 col-md-11 col-lg-11 col-xl-11 bg-light ml-3 mb-5 mr-5">
          ...
          <a href="#"> <div class="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4 clearfix float-left bg-light   mt-3" style="width:auto;
      height:122.5px; border:2px solid #999;">
       <img   src="bakım images/smart-defrag-icon.png" class="img-fluid  mt-3" style=" width:300px; height:90px;"></div></a>
        
      <a href="#" >  <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8 clearfix bg-light float-left  mb-2 mt-3 " style=" width:auto; height:122.5px; border:2px solid #999;     	       border-left:none; ">
        <h6 style="color:#09F; font-weight:bold;">Smart Defrag Full İndir</h6>
        <span id="box5" style="font-size:14px; color:#8C8C8C; font-weight:500;">Program’a Hızlı Bakış Program: IObit SmartDefrag Platform: Bilgisayar İşletim Sistemi: Windows XP<b style=" font-size:14px; font-weight:500;"> / 7 / 8 / 10Programlar Dil: Türkçe Program Sürümü: v 6.2.5.129 Ek Paket: Bulunmamaktadır<span> Geliştirici: IObit Yayımcı: IObit</span></b>...</span></span></div></a>
        ...
        <div class="btn-group mx-auto" role="group" >
         <button type="button" class="btn btn-light text-info disabled" style="border:2px solid #0CF; font-weight:bold;" >1/200</button>
   		<a href="index.html"> <button type="button" class="btn btn-info" style="border:2px solid #0CF; border-left:none; font-weight:bold;">1</button></a>
    	<a href="sayfa2.html"> <button type="button" class="btn btn-info active" style="border:2px solid #0CF; border-left:none; font-weight:bold;">2</button></a>
        <a href="#"> <button type="button" class="btn btn-info" style="border:2px solid #0CF; border-left:none; font-weight:bold;">3</button></a>
