            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" class="d-block">
                ...
                <ul class="navbar-nav mr-auto ml-3">
                    <li class="nav-item px-3" style=" border-right:1px solid #A6A6A6;">
                        <a class="nav-link " href="index.html" title="Ana Sayfa">Ana Sayfa <span class="sr-only">(current)</span></a>
                    </li>

                    <li class="nav-item px-3" style=" border-right:1px solid #A6A6A6;">
                        <a class="nav-link" href="oyun.html" title="Oyun">Oyun</a>
                    </li>

                    <li class="nav-item  px-3 " style=" border-right:1px solid #A6A6A6;">
                        <a class="nav-link" href="prgrm.html" title="Program">Program</a>
                    </li>
                    ...
                    <li class="nav-item px-3" style=" border-right:1px solid #A6A6A6;">
                        <a class="nav-link active" href="#" title="Önerileriniz">Önerileriniz</a>
                    </li>
